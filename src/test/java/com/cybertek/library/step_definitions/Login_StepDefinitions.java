...
public class Login_StepDefinitions {
    ...
    public void i_login_as_a_librarian() {
        String username = ConfigurationReader.getProperty("lib44_user");
        String password = ConfigurationReader.getProperty("lib44_pass");
    ...
    public void accountHolderNameShouldBe(String expectedAccountUserName) {
        ...
        String actualAccoutUsername = landingPage.accountUsername.getText();

        Assert.assertEquals("Account username is not as expected!",
                expectedAccountUserName, actualAccoutUsername);
